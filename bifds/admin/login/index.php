...
$error = "";
   ...
   $account_number = $_POST['account_number'];
    ...
    $sql = "SELECT * from users where account_number = '$account_numberv'  && password = '$passwordv' ";
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form method="POST">
        <?= $error ?>
      <input type="text" id="login" class="fadeIn second" name="account_number" placeholder="Account number">
