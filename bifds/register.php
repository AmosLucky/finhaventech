        ...
        if(strlen($username) > 1){
          ...
          if($numRows == 0){
           /////////////////////////////////////////////////////////////////////////////////////
            ...
            $result = mysqli_query($con,$sql) or die(mysqli_error($con));
            if($result){
               $success_msg = "<div class='alert alert-success'>Account creation was successful <br> <h3>Account Id: $account_number</h3> </div>";
...
<body>
                            ...
                            <div class="row">
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="hidden" placeholder="Initial Balance"
                                            class="form-control" name="balance" 
                                            value="<?php echo $balance?>" required></div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="hidden" placeholder="Fixed Deposit"
                                ...
                                <div class="col-lg-6">
                                 ...
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                       ...
                                       value="<?php echo $address?>" require><?php echo $address?></textarea>
                                        </div>
                                </div>

                                  <div class="col-lg-6">
                                    <div class="form-group">
                                       <textarea class="form-control" require placeholder="Occupation" name="occupation" value="<?php echo $occupation?>"><?php echo $occupation?></textarea>
                                        </div>
                                </div>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
                               ...
                               <!--  <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="send-btn">
                                        <button type="submit" class="btn btn-primary d-block w-100" name="apply">
                                    Create
                                            <span></span>
                                        </button></div>
                                        <br>
