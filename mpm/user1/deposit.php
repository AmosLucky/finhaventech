                                ...
                                <div class="basic-form">
                                 ...
                                 while ($row = mysqli_fetch_array($result)) {
                                   ...
                                   while ($row = mysqli_fetch_array($result)) {
                                      ...
                                      $min1 = number_format($row['min_deposite']);
                                      $max1 =  "Unlimited"; //number_format($max);
                                      ...
                                      // $ref_balance  = $row['referral_balance'];
                                       $id = $row['id'];
                                            ...
                                            ?>
                                   <option style="height:100px" value="<?php echo $id."-".$min."-".$name."-".$max ?>"><?php echo $name." $($min1 - $max1)" ?></option>
                                        ...
                                        <div class="input-group mb-3  ">
                                            ...
                                            <input type="number" placeholder="amount" required="" name="amount" class="form-control" id="amount" 
