...
$amount = $_POST['amount'];
  ...
  if($amount > 0){
    ...
    if($balance >= $amount){
      ...
      //////////////////////////////////DEBIT USER BALANCE///
         $sql = "UPDATE members set balance = balance - '$amount', running_invest = running_invest + $amount where id = '$user_id'";
  ...
  $result = mysqli_query($con,$sql) or die("Can not submit ".mysqli_error($con));
  if($result){
   echo  $msg =  '<div class="alert alert-success text-center">Investment Started counting</div>';
...
<div style='padding: 10px; background-color: black; color: white;height: 300px'>
  ...
  <p>Congratulations $username, your Reinvestment of  USD $amount has been approved;
    <br>
