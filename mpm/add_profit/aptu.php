               ...
               $max =  $row['max_deposite'];
                ...
                $capital_after =  $row['capital_after'];
                 ...
                 // echo "==".$hundred_percent_profit_one_day."==".$profit_after."====";
                  ...
                  //$profit_percent = (float)$daily_profit / 100;

              $new_profit = $amount * $hundred_percent_of_profit;
               $new_profit = $new_profit; ///////////30mins for 24hrs
               ///////////////////for adding profit//////////
                ...
                $total_capital_hours = $capital_after*24;
                 ...
                 $new_capital_running_hours  = (float)$capital_running_hours + 24; //part of 24hrs
                 $new_profit_running_hours  =  (float)$profit_running_hours + 24;
