			...
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h6 class="modal-title">Account Verification</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
					<div class="modal-body">
						<h6>Welcome <?php echo $user ?></h6>
						<p>You are required to verify your account and get green check mark (KYC VERIFICATION) </p>
					</div>
					<div class="modal-footer">
						<a href="account"><button class="btn ripple btn-primary" type="button">Verify</button></a>
						...
						<div class="card crypto crypt-primary overflow-hidden">
							<div class="card-body iconfont text-left">
								<div class="media">
									<div class="media-body">
										<h6>Profit</h6>
										<h3 class="font-weight-semibold text-left mb-0 text-success"> (USD) <?php  echo  number_format($profit,3)  ?></h3>
									...
									<i class="mdi mdi-arrow-up-drop-circle mr-1 text-success" aria-hidden="true"></i>Investemnt Profit 
								</p>
									</div>
									
								</div>
								<div class="flot-wrapper">
									<div class="flot-chart ht-150 mt-4" id="flotChart3" style="padding: 0px;">
										<canvas class="flot-base" style="direction: ltr; position: absolute; 
										left: 0px; top: 0px; width: 356.664px; height: 150px;" width="713" 
										height="300"></canvas><canvas class="flot-overlay" 
										style="direction: ltr; position: absolute; left: 0px; top: 
										0px; width: 356.664px; height: 150px;" width="713" height="300"></canvas></div>
								</div>
							</div>
							<div class="card-footer">
								<nav class="nav">
