	...
	<div class="page">
		...
		<aside class="app-sidebar sidebar-scroll ">
			<div class="main-sidebar-header">
				<a class=" logo-light" href="index"><img src="../images/logo-dark.png" class="" alt="logo"></a>
			...
			<div class="main-sidebar-body circle-animation ">
				...
				<ul class="side-menu circle">
					...
					<li><span class="side-menu__label ml-3"><b>
								<?php echo $user ?>
							</b>
							<?php 
					if($is_verified >2){
					...
					?>
							<img alt="" src="../uploads/verificationtag.png" height="30">
							<?php } ?>
						</span></li>
									...
									<div class="main-message-list chat-scroll">
										...
										<a href="notification.php?p=<?php echo $id ?>" class="p-3 d-flex border-bottom">
											<div class="  drop-img  cover-image  "
												data-image-src="assets/img/faces/avatar.jpg">
								...
								<div class="dropdown-menu dropdown-menu-arrow animated fadeInUp">
									...
									<div class="main-message-list text-scroll">
										...
										<li>
											...
											<a href="notification.php?p=<?php echo $id ?>"
