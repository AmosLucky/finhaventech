  ...
  $min =  $_POST['min'];
   ...
   $profit =  $_POST['profit'];
    $capital_after =  $_POST['capital_after'];
     $profit_after = 1; //  $_POST['profit_after'];
     $referal_bonus =  $_POST['referal_bonus'];
     $date_created = date("y-m-d");

     $query = "INSERT INTO investment_plans (name,min_deposite,max_deposite,profit,capital_after,referal_bonus,profit_after,daily_profit,reg_date,deleted)values( 
      '$name',
      '$min',
      '$max',
      '$profit',
...
<div class="content">
    <div class="container-fluid">
        ...
        <!-- Start Widget -->
        <!--Widget-4 -->
        <div id="usd" class="modal fade" tabindex="-1" role="dialog"
        ...
        <div id="del_tra" class="modal fade" tabindex="-1" role="dialog"
            aria-labelledby="myModalLabel" aria-hidden="true"
            style="display: none">
            <!-- /.modal-dialog -->
        </div>

        <button style="display: none;" type="button" id="show_tra"
            data-toggle="modal" data-target="#usd"></button>
        <button style="display: none;" type="button" id="show_del"
            data-toggle="modal" data-target="#del_tra"></button>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number"
                                            class="form-control" name="referal_bonus"
                                    ...
                                    <table id="datatable"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>$ <?php echo $min ?></td>
                                                <td>$ <?php echo $max ?></td>
                                                <td><?php echo $referal_bonus ?> %</td>
                                                <td><?php echo $capital_after ?> Day(s)</td>
                                                <td>
                                                    <!-- <button type="button"
                                                        class="btn btn-sm btn-primary btn-custom "
                                                        value="53"
                                                        onclick="show_settings_modal(1,this.value,'#usd','#show_tra')">View</button> -->
