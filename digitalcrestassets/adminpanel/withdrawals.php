...
if(isset($_GET['type'])){
  ...
  switch($type){
    case "completed":
      $sql = "SELECT * FROM transactions where transaction_type = 'Withdrawal' and status ='approved' order by id desc";
      $type = "completed";
      break;
    case "pending":
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header bg-primary">
                                        <h3 class="card-title text-white"><?php echo $type ?> Withdrawals</h3>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
    ...
    # code...
                ...
                <tr>
                  ...
                  <td style="display:flex">
                    <a href="view_withdrawal.php?t_id=<?php echo $id ?>"><button class="btn btn-primary" style="margin-right:3px">View</button></a>
                    <form method="POST">
