                    ...
                    <div id="accordion-1" class="accordion accordion-faq">
                        ...
                        <div class="card">
                            <div class="card-header py-4" id="heading-1-1" data-bs-toggle="collapse" role="button"
                                ...
                                <h6 class="mb-0"><span class="ti-receipt mr-3"></span> What is <?= $company_name ?>?</h6>
                            </div>
                            <div id="collapse-1-1" class="collapse" aria-labelledby="heading-1-1"
                                 data-parent="#accordion-1">
                                <div class="card-body">
                                    <p><?= $company_name ?> our company provides a full investment service focused on the bitcoin and cryptocurrency market We are among the best platforms to invest and grow your bitcoin and other cryptocurrency</p>
                                </div>
                            </div>
                        </div>
                        <!-- Accordion card 3 -->
                    ...
                    <div id="accordion-1" class="accordion accordion-faq">
                        ...
                        <div class="card">
                            <div class="card-header py-4" id="heading-1-4" data-bs-toggle="collapse" role="button"
                                ...
                                <h6 class="mb-0"><span class="ti-receipt mr-3"></span> How long does my deposit take before it can reflect on my <?= $company_name ?> account dashboard?</h6>
                            </div>
                    ...
                    <div id="accordion-2" class="accordion accordion-faq">
                        ...
                        <div class="card">
                            ...
                            <div id="collapse-2-5" class="collapse" aria-labelledby="heading-2-5"
                                ...
                                <div class="card-body">
                                    <p>To make a withdrawal request click the WITHDRAW button at the top center of your <?= $company_name ?> account dashboard and input the required details to withdraw</p>
                                </div>
                            </div>
                        </div>
                        <!-- Accordion card 3 -->
                    ...
                    <div id="accordion-2" class="accordion accordion-faq">
                        ...
                        <div class="card">
                            ...
                            <div id="collapse-2-8" class="collapse" aria-labelledby="heading-2-8"
                                 data-parent="#accordion-2">
                                <div class="card-body">
                                    <p>Yes we are officially and properly registered with the United State . our company registration number is USFDAISO34847676   and registered with the name <?= $company_name ?></p>
                                </div>
                            </div>
                        </div>
                        <!-- Accordion card 3 -->
