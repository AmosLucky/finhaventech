            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="about-one__right">
                        ...
                        <p>We encourage you to review the privacy policy whenever you interact with us to stay informed about our information practices and the ways you can help protect your privacy. This privacy policy applies to the Services provided by <?= $company_name ?> (“we” or “us”).</p>

                        <h4>2. Collection of Information</h4>
                        <p>When you create an <?= $company_name ?> account, we may collect information, including non-public personal information about you from non-affiliated third party service providers in order to verify your identity and for fraud prevention, including your prior addresses and names.</p>
