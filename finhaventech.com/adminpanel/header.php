            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        <div class="pull-left">
                            <img src="assets/images/admin.png" alt="" class="thumb-md rounded-circle" width="30px" height="auto">
                        </div>
                        <div class="user-info">
                            <div class="dropdown">
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled" style="display: block;">
                                    ...
                                    <li class=""><a href="verify_member.php">Approve Verification</a></li>
                                </ul>
                            </li>
                            
                            <li class="has_sub d-non">
                                <a href="#" class="waves-effect subdrop ">
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled" style="display: block;">
                                    <li class=""><a href="send_message.php">Send Messages</a></li>
