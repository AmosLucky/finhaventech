...
<head>
    ...
    <title>Account Recovery Page - <?= $company_name ?></title>
    <style>
        .gradient-custom {
                ...
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-md-4 pb-5">
                            <h2 class="fw-bold mb-2 text-uppercase">Account Recovery Page</h2>
                            <p class="text-white-50 mb-5">Enter your email to recover your account</p>
                            <form method="post" action="">
                                                                <input type="hidden" name="_token" value="za1IhQVNYh6TQOfToFMBgXfSutKrVgD7c4x56AXo">                                <div class="form-outline form-white mb-4 col-md-12">
